...
static const char *MARK_FG[]  = { "Nsxiv.mark.foreground",     "red" };
#if HAVE_LIBFONTS
static const char *BAR_BG[]   = { "Nsxiv.bar.background",       "black" };
static const char *BAR_FG[]   = { "Nsxiv.bar.foreground",       "white" };
